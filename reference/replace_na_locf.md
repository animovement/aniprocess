...
Replaces missing values by carrying forward the last observed value,
with control over both minimum and maximum gap sizes to fill.
...
A numeric vector with NA values replaced by the last observed value
